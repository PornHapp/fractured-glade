...
# --- НАСТРОЙКИ ГЛАЗ ---
var fade_time = 3.5 # За сколько секунд глаз плавно появляется и исчезает
var show_time = 2.0 # Сколько секунд глаз "смотрит" на игрока, прежде чем исчезнуть
var min_delay = 1.0 # Минимальная пауза перед появлением нового глаза
var max_delay = 3.5 # Максимальная пауза
